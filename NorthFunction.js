...
var id = "northfunction";
var name = "North Function";
var description = "North function is custom theory created by the owner YouSlovenia (GitHub) or AustriaMapping (Discord)";
var authors = "AustriaMapping";
var version = 0.0;
...
var init = () => {
    ...
    currency_Q = theory.createCurrency("Q", "Q");
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(0, currency_N, new FirstFreeCost(new ExponentialCost(50, Math.log2(2))));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency_N, new ExponentialCost(20, Math.log2(10)));
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(2, currency_N, new ExponentialCost(100, Math.log2(10)));
...
var tick = (elapsedTime, multiplier) => {
    ...
    currency_N.value += dt * bonus * getC1(c1.level).pow(getC1Exponent(c1Exp.level)) *
